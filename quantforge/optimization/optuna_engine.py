...
class OptunaEngine:
    ...
    def _suggest_catboost(self, trial, cfg: Dict[str, Any]) -> Dict[str, Any]:
        ...
        cfg["devices"] = "0" if os.environ.get("CUDA_VISIBLE_DEVICES") else cfg.get("devices", "0")
    ...
    def optimize(self, n_trials=100, storage=None, study_name="QuantForge", load_if_exists=True):
        ...
        (study_dir / f"{study.study_name}_best.json").write_text(json.dumps(best_payload, indent=4, default=str))
