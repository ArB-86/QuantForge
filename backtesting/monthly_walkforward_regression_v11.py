# File: backtesting/monthly_walkforward_regression_v11.py
...
CHECKPOINT_FILE = (
    "data/checkpoints/"
    "monthly_walkforward_regression_v11.csv"
)

MODEL_FILE = (
    "models/monthly_lightgbm_regressor_v11.pkl"
)
...
for i in range(36, len(months) - 1):
    ...
    # =====================
    # FINAL MODEL (fixed hyperparameters)
    # =====================
